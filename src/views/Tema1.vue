  ...
  .curso-main-container.pb-3.tema1
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .row.justify-content-start.mb-4(data-aos="zoom-in-left")
          .col-sm-12.col-lg-7
            .d-flex.align-items-center.mt-4
              img.w-card-icon(src="@/assets/curso/temas/tema1/ico3.svg")
              h3.bg13.py-2.w-card-text Línea de productos
      ...
      .row.justify-content-start.mb-4(data-aos="zoom-in-left")
          .col-sm-12.col-lg-7
            .d-flex.align-items-center.mt-4
              img.w-card-icon(src="@/assets/curso/temas/tema1/ico4.svg")
      ...
      .row.justify-content-start.mb-4(data-aos="zoom-in-left")
          .col-sm-12.col-lg-7
            .d-flex.align-items-center.mt-4
              ...
              h3.bg13.py-2.w-card-text Elementos de identidad corporativa
      ...
      .row.justify-content-center.mb-4
        .col-lg-11
          .bloque-texto-g.fondo-b.p-3.p-sm-4.p-md-5
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/temas/tema1/img08.png')})`}"
            )
            ...
            .row.justify-content-around.align-items-center
              ...
              .col
                .row.justify-content-between.align-items-center
                  .col.mb-3.mb-sm-0
                    h4.mb-3.text-white.my-3 #[b En una campaña de este tipo, el mensaje puede llegar al público objetivo a través de mensajes de texto o insertos en prensa escrita, pasando por telemercadeo y comerciales de televisión.]
